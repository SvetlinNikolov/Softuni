...
namespace SoftUniRestaurant.Models.Drinks.Entities
{
    public abstract class Drink : IDrink
    {
        ...
        {
            // Returns a string with information about each drink.
            //Not quite sure here same as food class
            //Maybe need to show information about all existing types of drinks and foods
